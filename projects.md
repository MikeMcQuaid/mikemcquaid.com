...
Maintainer. Improved Homebrew integration, general bug fixing and updates. [Migrated GitHub](/2016/06/15/replacing-boxen/) to use [Strap](https://github.com/MikeMcQuaid/strap) instead. Transitioned project to community ownership and (eventually) archived status.
