...
Yeah, we've talked about that a bit. So, my little concept that I've written and talked about is: I think that it's like a kind of funnel. A bit likes a sales funnel, a kind of [contributor funnel]({% post_url 2018-08-14-the-open-source-contributor-funnel-why-people-dont-contribute-to-your-open-source-project %}). With the idea being; every user is a potential contributor. Or every contributor is a potential maintainer. But then, for each level you go down the funnel, you get a fairly major kind of drop off.
