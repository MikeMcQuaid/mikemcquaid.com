...
So I think they're kind of a good way for people to get to meet other people who are working on similar things. So, for example, our Homebrew meeting we had where we did all those votes, we did that at a conference. Like the day afterwards so everyone could attend the conference and stuff like that, that was the [FOSDEM conference](https://fosdem.org/2019/) in Belgium. So I think they are good ways of getting people together and I've worked from home for ten years as well, so it feels kind of similar to, in my job as well, when I feel like when people have met face to face and actually had social interaction they generally work better. They cut each other more slack and they've got more of a relationship in general and that's a positive thing.
