---
excerpt: 'Hypothesis: "Ajax applications can provide a more effective user interface than those of GUI desktop or classic Web applications with fewer drawbacks than either individual approach."'
redirect_from:
- /2007/02/27/making-dizzy-shine-with-ajax/
---
