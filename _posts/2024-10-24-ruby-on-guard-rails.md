...
- [Workbrew](https://workbrew.com) (2023-2025): I co-founded Workbrew and, as the sole engineer at the time, designed and built the initial Workbrew Console Ruby on Rails application from scratch.
...
My approach when using linters in Homebrew, Workbrew and the parts of GitHub where I had sufficient influence was:
...
For the initial Workbrew Console application, the test suite I built ran like this:
